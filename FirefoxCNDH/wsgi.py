"""
WSGI config for FirefoxCNDH project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "FirefoxCNDH.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "FirefoxCNDH.settings")
